...
public class RootController {
  ...
  public Map<String, Object> getInfo() {
    return Map.of("success", true, "data", AiServicesConfig.getAllServices());
  }

  @GetMapping("/api/test")
  public Map<String, Object> testGet() {
    System.out.println("GET /api/test");
    return Map.of("success", true, "method", "GET", "message", "GET request successful");
  }
  ...
  public Map<String, Object> testPost(@RequestBody(required = false) Map<String, Object> body) {
    ...
    return Map.of("success", true, "method", "POST", "received",
      body != null ? body : Map.of("info", "no body provided"));
  }

  @PutMapping("/api/test")
  public Map<String, Object> testPut(@RequestBody(required = false) Map<String, Object> body) {
    System.out.println("PUT /api/test: " + body);
    return Map.of("success", true, "method", "PUT", "updated",
      body != null ? body : Map.of("info", "no body provided"));
  }
  ...
  public Map<String, Object> testDelete(@RequestParam(name = "id", required = false) String id) {
    ...
    return Map.of("success", true, "method", "DELETE", "deletedId", id != null ? id : "undefined");
  }
